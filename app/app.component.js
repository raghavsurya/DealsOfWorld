    ...
    return {
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent(http, _productService) {
                    var _this = this;
                    this._productService = _productService;
                    this.rootVar = "us";
                    this.pageTitle = 'Deals of World Application';
                    http.get('http://DealsOfWorld.com:3000/api/v1/Menus/' + this.rootVar).map(function (res) { return res.json(); })
                        .subscribe(function (allMenus) { return _this.menus = allMenus; });
                    http.get('http://DealsOfWorld.com:3000/api/v1/SideMenus/' + this.rootVar + '/all').map(function (res) { return res.json(); })
                ...
                AppComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [http_1.Http, productService_1.ProductService])
                ], AppComponent);
                return AppComponent;
            }());
