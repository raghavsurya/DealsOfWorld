System.register(['angular2/core', './products/product-list.component', 'angular2/http', 'rxjs/Rx', './services/productService', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, product_list_component_1, http_1, productService_1, router_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AppComponent = (function () {
                ...
                AppComponent.prototype.FormatMenu = function (menu) {
                ...
                AppComponent = __decorate([
                    router_1.RouteConfig([
                        { path: '/', name: 'Products', component: product_list_component_1.ProductListComponent },
                        { path: '/products/:country/:brand', name: 'ProductByCategory', component: product_list_component_1.ProductListComponent },
                        { path: '/:country/:brand/:category', name: 'ProductByCategoryByBrand', component: product_list_component_1.ProductListComponent }
                    ]),
                    core_1.Component({
                        selector: 'dw-app',
                        //viewProviders: [HTTP_PROVIDERS],
                        directives: [product_list_component_1.ProductListComponent, router_1.ROUTER_DIRECTIVES],
                        providers: [productService_1.ProductService, http_1.HTTP_PROVIDERS, router_1.ROUTER_PROVIDERS],
