            ...
            ProductFilterPipe = (function () {
                ...
                ProductFilterPipe.prototype.transform = function (value, args) {
                    if (typeof value != 'undefined') {
                        var filteredStr_1 = args[0] ? args[0].toLocaleLowerCase() : null;
                        return filteredStr_1 ? value.filter(function (product) {
                            return product.productText.toLocaleLowerCase().indexOf(filteredStr_1) != -1;
                        }) : value;
                    }
                    return value;
                    //return value;
